...
public:
    ...
    void depthfirst(Artist &start, Artist &end, ostream &out);
    void breadthfirst(Artist &start, Artist &end, ostream &out);
    void no(Artist &start, Artist &end,vector<Artist> blocked, ostream &out);

    void no_path(string start, string end, ostream &out);
    void path_printer(stack<Artist> path, ostream &out);
